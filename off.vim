...
let s:actual_white    = { "gui": "#F1F1F1", "cterm": "231" }
let s:light_black     = { "gui": "#424242", "cterm": "8"   }
let s:lighter_black   = { "gui": "#545454", "cterm": "240" }
let s:subtle_black    = { "gui": "#303030", "cterm": "236" }
let s:light_gray      = { "gui": "#B2B2B2", "cterm": "249" }
let s:lighter_gray    = { "gui": "#dad5b8", "cterm": "251" }
...
if &background == "dark"
  ...
  let s:bg_subtle_comment = s:light_green
  let s:bg_very_subtle  = s:dark_green
  let s:norm            = s:lighter_gray
  let s:norm_subtle     = s:lighter_gray
  let s:purple          = s:light_purple
  let s:cyan            = s:light_green
...
call s:h("Error",         {"fg": s:lighter_gray, "bg": s:black, "cterm": "bold"})
call s:h("Todo",          {"fg": s:actual_white, "bg": s:black, "gui": "bold", "cterm": "bold"})
call s:h("SpecialKey",    {"fg": s:light_green})
call s:h("NonText",       {"fg": s:lighter_gray})
call s:h("Directory",     {"fg": s:dark_blue})
call s:h("ErrorMsg",      {"fg": s:pink})
call s:h("IncSearch",     {"bg": s:yellow, "fg": s:light_black})
call s:h("Search",        {"bg": s:bg_subtle, "fg": s:norm})
call s:h("MoreMsg",       {"fg": s:lighter_gray, "cterm": "bold", "gui": "bold"})
...
call s:h("Folded",        {"fg": s:lighter_gray})
...
call s:h("TabLineSel",    {"fg": s:orange, "bg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
call s:h("TabLineFill",   {"fg": s:norm, "bg": s:bg_very_subtle})
call s:h("CursorColumn",  {"bg": s:bg_very_subtle})
call s:h("CursorLine",    {"fg": s:norm, "bg": s:bg_very_subtle})
call s:h("ColorColumn",   {"bg": s:bg_subtle})

call s:h("MatchParen",    {"bg": s:black, "fg": s:green})
call s:h("qfLineNr",      {"fg": s:lighter_gray})
...
if colors_off_a_little
    ...
    hi! TelescopeMatching            guifg=#5FD7A7 guibg=NONE ctermbg=NONE
    highlight TelescopeSelection     guifg=NONE gui=bold guibg=NONE
else
